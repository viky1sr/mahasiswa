...
@section('kepo')
    <!-- start banner Area -->
    <section class="banner-area relative" id="home" style="background: url('{{config('sekolah.image_benner_url')}}');">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-feature">
                        <div class="title">
                            <h4>{{config('sekolah.home_feature_colum_1_title')}}</h4>
                        </div>
                        <div class="desc-wrap">
                            <p>
                                {{config('sekolah.home_feature_colum_1_content')}}
                            </p>
                            <a href="{{config('sekolah.home_feature_colum_1_link_url')}}">{{config('sekolah.home_feature_colum_1_link_text')}}</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-feature">
                        <div class="title">
                            <h4>{{config('sekolah.home_feature_colum_2_title')}}</h4>
                        </div>
                        <div class="desc-wrap">
                            <p>
                                {{config('sekolah.home_feature_colum_2_content')}}
                            </p>
                            <a href="{{config('sekolah.home_feature_colum_2_link_url')}}">{{config('sekolah.home_feature_colum_2_link_text')}}</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-feature">
                        <div class="title">
                            <h4>{{config('sekolah.home_feature_colum_3_title')}}</h4>
                        </div>
                        <div class="desc-wrap">
                            <p>
                                {{config('sekolah.home_feature_colum_3_content')}}
                            </p>
                            <a href="{{config('sekolah.home_feature_colum_3_link_url')}}">{{config('sekolah.home_feature_colum_3_link_text')}}</a>
                        </div>
                    </div>
                </div>
            </div>
