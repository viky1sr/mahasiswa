<nav class="navbar navbar-default navbar-fixed-top">
    <div class="brand">
        <img src="{{asset('admin/loga-mh.png')}}" width="70" alt="Klorofil Logo" class="img-responsive logo">
    </div>
    <div class="container-fluid">
        ...
        <form class="navbar-form navbar-left" method="GET" action="/siswa">
            <div class="input-group">
                <input name="" value="" type="search" class="form-control" placeholder="Search Dashboard">
